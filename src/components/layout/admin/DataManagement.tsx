            ...
            <TabsContent value='orders'>
                <table className='w-full'>
                    <thead className='bg-gray-50'>
                        <tr>
                            <th className='px-6 py-3 text-left text-xs font-medium uppercase text-gray-600 tracking-wide'><Checkbox /></th>
                    ...
                    <tbody className='divide-y divide-gray-200'>
                        <tr className='hover:bg-gray-50'>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><Checkbox /></td>
