export const format = {
  ...
  dateD: (iso: Date) => iso.toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }),
  time: (iso: string) => new Date(iso).toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit" }),
  timeD: (iso: Date) => iso.toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit" }),
};